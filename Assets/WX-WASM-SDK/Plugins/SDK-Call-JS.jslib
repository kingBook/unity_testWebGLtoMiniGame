mergeInto(LibraryManager.library, {
    ...
    WXPreLoadShortAudio:function(s){
        window.WXWASMSDK.WXPreLoadShortAudio(Pointer_stringify(s));
    },
    WXStopOthersAndPlay:function(audio,loop,volume){
        window.WXWASMSDK.WXStopOthersAndPlay(Pointer_stringify(audio),loop,volume);
    },
    WXShortAudioPlayerStop:function(audio){
        window.WXWASMSDK.WXShortAudioPlayerStop(Pointer_stringify(audio));
    },
    WXShortAudioPlayerDestroy:function(audio){
        window.WXWASMSDK.WXShortAudioPlayerDestroy(Pointer_stringify(audio));
    },
    WXSetClipboardData:function(str, s, f, c){
        window.WXWASMSDK.WXSetClipboardData(Pointer_stringify(str), Pointer_stringify(s), Pointer_stringify(f), Pointer_stringify(c));
    },
    WXGetClipboardData:function( s, f, c){
        window.WXWASMSDK.WXGetClipboardData(Pointer_stringify(s), Pointer_stringify(f), Pointer_stringify(c));
    },
    WXShowToast:function( title, icon, duration, mask,  s,  f,  c){
        window.WXWASMSDK.WXShowToast(Pointer_stringify(title),Pointer_stringify(icon),duration,mask,Pointer_stringify(s), Pointer_stringify(f), Pointer_stringify(c));
    },
    WXHideToast:function(s,  f,  c){
        window.WXWASMSDK.WXHideToast(Pointer_stringify(s), Pointer_stringify(f), Pointer_stringify(c));
    },
    WXShowModal:function( conf, s,  f,  c){
        window.WXWASMSDK.WXShowModal(Pointer_stringify(conf), Pointer_stringify(s), Pointer_stringify(f), Pointer_stringify(c));
    },
    WXShowLoading:function( conf, s,  f,  c){
        window.WXWASMSDK.WXShowLoading(Pointer_stringify(conf), Pointer_stringify(s), Pointer_stringify(f), Pointer_stringify(c));
    },
    WXHideLoading:function(s,  f,  c){
        window.WXWASMSDK.WXHideLoading(Pointer_stringify(s), Pointer_stringify(f), Pointer_stringify(c));
    },
