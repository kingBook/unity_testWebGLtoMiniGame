...
// 如果是h5，基础库需要>=2.19.1，iOS版本需要>=14.0
...
export default () => {
  return new Promise((resolve, reject) => {
    ...
    if (platform !== 'devtools') {
      if (!compareVersion(version, '7.0.19') || !compareVersion(SDKVersion, '2.14.0') || (isH5Renderer && (!isH5ValidLibVersion || !isH5SystemVersionValid))) {
        wx.showModal({
          title: '提示',
          content: '当前微信版本过低\n请更新微信后进行游戏',
          showCancel: false,
